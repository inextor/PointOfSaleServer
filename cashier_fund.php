...
class Service extends SuperRest
{
	function get()
	{
		...
		$extra_sort = array();
		$this->is_debug = true;
		return $this->genericGet("cashier_fund",$extra_constraints,$extra_joins,$extra_sort);
	}
	...
	{
		return $this->genericInsert($array,"cashier_fund");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "cashier_fund", $insert_with_ids );
	}
	...
	function delete()
	{
		try
		{
			return $this->genericDelete("cashier_fund");
		}
		catch(LoggableException $e)
		{
			DBTable::rollback();
