...
class Service extends SuperRest
{
	function get()
	{
		...
		$extra_sort = array();
		$this->is_debug = true;
		return $this->genericGet("commanda",$extra_constraints,$extra_joins,$extra_sort);
	}
	...
	{
		return $this->genericInsert($array,"commanda");
	}

	function batchUpdate($array)
	{
		$insert_with_ids = false;
		return $this->genericUpdate($array, "commanda", $insert_with_ids );
	}
	...
	function delete()
	{
		try
		{
			return $this->genericDelete("commanda");
		}
		catch(LoggableException $e)
		{
			DBTable::rollback();
