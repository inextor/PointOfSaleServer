...
class Service extends SuperRest
{
	function get()
	{
		...
		$extra_sort = array();
		$this->is_debug = true;
		return $this->genericGet("fund",$extra_constraints,$extra_joins,$extra_sort);
	}
	...
	function batchInsert($array)
	{
		...
		$system_values		= array('created_by_user_id'=>$user->id,'updated_by_user_id'=>$user->id);
		return $this->genericInsert($array,"fund",$optional_values,$system_values);
	}
}
$l = new Service();
$l->execute();
